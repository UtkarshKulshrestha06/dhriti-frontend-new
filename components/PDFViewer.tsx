...
import { X, Download, Maximize2, ZoomIn, ZoomOut, ExternalLink, PenTool, Eraser, Palette, Check } from 'lucide-react';
      ...
      >
        ...
        >
            ...
            >
                ...
                {/* PDF Iframe */}
                <div className={`w-full h-[150vh] bg-white rounded-lg overflow-hidden ${isDrawingMode ? '' : ''}`}>
                    <iframe 
                        src={`${url}#toolbar=0&navpanes=0&scrollbar=0`} 
                        className="w-full h-full block"
                        title="PDF Viewer"
                        style={{ pointerEvents: isDrawingMode ? 'none' : 'auto' }} // Disable iframe interaction when drawing to prevent hijacking
                    >
                        <div className="flex flex-col items-center justify-center h-full text-gray-500">
                            <p className="mb-4">This browser does not support PDFs. Please download the PDF to view it.</p>
                            <a href={url} download>
